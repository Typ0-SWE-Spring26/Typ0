...
class StartMenu:
    ...
    async def run(self):
        ...
        while self.running:
            ...
            self.start_rect = pygame.Rect(self.screen.get_width() // 4, self.screen.get_height() // 2 +10, 400, 75)
            pygame.draw.rect(self.screen, (60, 60, 120), self.start_rect, border_radius=8)
            ...
            self.settings_rect = pygame.Rect(self.screen.get_width() // 4, self.screen.get_height() // 2+110, 400, 75)
            pygame.draw.rect(self.screen, (60, 60, 120), self.settings_rect, border_radius=8)
